...
public class CheckTrains extends JFrame {
    ...
    CheckTrains(String username) {
        ...
        JLabel number = new JLabel("Train Number");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/booknow.png"));
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow != -1) {
                        ...
                        String trainName = (String) model.getValueAt(selectedRow, 0);
                        String trainNumber = (String) model.getValueAt(selectedRow, 1);
                        String timings = (String) model.getValueAt(selectedRow, 2);
                        String fare = (String) model.getValueAt(selectedRow, 3);

                        storeDetailsInDatabase(username, trainName, trainNumber, timings, fare);
    ...
    private void storeDetailsInDatabase(String username, String trainName, String trainNumber, String timings, String fare) {
        try {
            Conn c = new Conn();
            String query = "CREATE TABLE IF NOT EXISTS booked_tickets ("
            ...
            query = "INSERT INTO booked_tickets (username, train_name, train_number, timings, fare) VALUES (?, ?, ?, ?, ?)";
    ...
    private void generateRandomData() {
        String[] trainNames = {"Rajdhani Express", "Shatabdi Express", "Sampark Kranti Express", "Humsafar Express", "Vande Bharat Express"};
