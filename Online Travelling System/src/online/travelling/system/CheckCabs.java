...
public class CheckCabs extends JFrame {

    JLabel labelusername, labelfrom, labelto;
    String username;
    DefaultTableModel model;

    CheckCabs(String username) {
        ...
        JLabel number = new JLabel("Cab Number");
        ...
        JLabel note = new JLabel("Note: Click on the row for which you would like to book the cab!");
        note.setBounds(30, 500, 800, 25);
        note.setFont(new Font("Tahoma", Font.PLAIN, 20));
        add(note);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/cab.jpeg"));
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow != -1) {
                        ...
                        String cabName = (String) model.getValueAt(selectedRow, 0);
                        String cabNumber = (String) model.getValueAt(selectedRow, 1);
                        String timings = (String) model.getValueAt(selectedRow, 2);
                        String fare = (String) model.getValueAt(selectedRow, 3);

                        storeDetailsInDatabase(username, cabName, cabNumber, timings, fare);
    ...
    private void storeDetailsInDatabase(String username, String cabName, String cabNumber, String timings, String fare) {
        try {
            Conn c = new Conn();
            String query = "CREATE TABLE IF NOT EXISTS cab_tickets ("
            ...
            query = "INSERT INTO cab_tickets (username, cab_name, cab_number, timings, fare) VALUES (?, ?, ?, ?, ?)";
            PreparedStatement ps = c.c.prepareStatement(query);
            ps.setString(1, username);
            ps.setString(2, cabName);
            ps.setString(3, cabNumber);
    ...
    private void generateRandomData() {
        String[] cabNames = {"Toyota Innova Crysta", "Renault Triber", "Hyundai Aura", "Tata Tigor", "Ford Aspire"};
